...
class EL_Local(Node):
    ...
    def run(self):
        ...
        """
        logging.info("run")
        self.testset = self.dataset.get_testset(0, True)
        ...
        for iteration in range(self.iterations):
            ...
            if self.dataset.__testing__ and rounds_to_test == 0:
                ...
                ta, tl = self.dataset.test(self.model.model, self.loss)
            ...
            def custom_serializer(obj):
                if isinstance(obj, (np.float32, np.float64)):  # Handle float32/float64
                    return float(obj)
                elif isinstance(obj, np.integer):  # Handle int32/int64
                    return int(obj)
            ...
            with open(
                ...
                json.dump(results_dict, of, default=custom_serializer)
